...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        devEduardo.progredir();
        System.out.println("-");
        System.out.println("Conteúdos Inscritos Camila:" + devEduardo.getConteudosInscritos());
        System.out.println("Conteúdos Concluídos Camila:" + devEduardo.getConteudosConcluidos());
        ...
        System.out.println("Conteúdos Inscritos João:" + devClaudio.getConteudosInscritos());
        devClaudio.progredir();
        devClaudio.progredir();
        devClaudio.progredir();
        System.out.println("-");
        System.out.println("Conteúdos Inscritos João:" + devClaudio.getConteudosInscritos());
        System.out.println("Conteúdos Concluídos João:" + devClaudio.getConteudosConcluidos());
